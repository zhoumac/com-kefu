...
public abstract interface OnlineUserRepository extends JpaRepository<OnlineUser, String> {
	public abstract OnlineUser findById(String id);
	...
	public abstract List<OnlineUser> findByUserid(String userid);
	...
	public abstract Page<OnlineUser> findByStatus(String paramString2, Pageable paramPageable);
