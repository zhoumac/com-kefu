...
public class QuickReplyRepositoryImpl implements QuickReplyEsCommonRepository{
	...
	public Page<QuickReply> getByOrgiAndCate(String orgi, String cate, String q, Pageable page) {
		log.error("知识库内容表 快捷回复表 getByOrgiAndCate 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public Page<QuickReply> getByQuicktype(String quicktype, int p, int ps) {
		log.error("知识库内容表 快捷回复表 getByQuicktype 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public Page<QuickReply> getByOrgiAndType(String orgi, String type, String q, Pageable page) {
		log.error("知识库内容表 快捷回复表 getByOrgiAndType 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public List<QuickReply> findByOrgiAndCreater(String orgi, String creater, String q) {
		log.error("知识库内容表 快捷回复表 findByOrgiAndCreater 使用了es QuickReplyRepositoryImpl ");
		return null;
	}
	//todo zhou findByCreater 知识库内容表
	@Override
	public List<QuickReply> findByCreater(String creater, String q) {
		log.error("知识库内容表 快捷回复表 findByCreater 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public Page<QuickReply> getByCateAndUser(String cate, String q, String user, int p, int ps) {
		log.error("知识库内容表 快捷回复表 getByCateAndUser 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public Page<QuickReply> getByCon(BoolQueryBuilder booleanQueryBuilder, int p, int ps) {
		log.error("知识库内容表 快捷回复表 getByCon 使用了es QuickReplyRepositoryImpl ");
		return null;
	}

	@Override
	public void deleteByCate(String cate, String orgi) {
		log.error("知识库内容表 快捷回复表 deleteByCate 使用了es QuickReplyRepositoryImpl ");

	}

	@Override
	public List<QuickReply> getQuickReplyByOrgi(String orgi, String cate, String type, String q) {
		log.error("知识库内容表 快捷回复表 getQuickReplyByOrgi 使用了es QuickReplyRepositoryImpl ");
		return null;
	}
	*/
...
/*@Override
	public Page<QuickReply> getByOrgiAndCate(String orgi , String cate , String q, Pageable page) {
		...
		log.error("知识库内容表 快捷回复表  使用了es QuickReplyRepositoryImpl ");
	    return pages ; 
	}
