...
public class KbsTopicRepositoryImpl  implements KbsTopicEsCommonRepository{
	...
	public Page<KbsTopic> getTopicByCate(String cate, String q, int p, int ps) {
		log.error("知识库内容表 getTopicByCate 使用了es KbsTopicRepositoryImpl ");
	...
	public Page<KbsTopic> getTopicByTop(boolean top, int p, int ps) {
		log.error("知识库内容表 getTopicByTop 使用了es KbsTopicRepositoryImpl ");
	...
	public List<KbsTopic> getTopicByOrgi(String orgi, String type, String q) {
		log.error("知识库内容表 getTopicByOrgi 使用了es KbsTopicRepositoryImpl ");
	...
	public Page<KbsTopic> getTopicByCateAndUser(String cate, String q, String user, int p, int ps) {
		log.error("知识库内容表 getTopicByCateAndUser 使用了es KbsTopicRepositoryImpl ");
	...
	public Page<KbsTopic> getTopicByCon(BoolQueryBuilder booleanQueryBuilder, int p, int ps) {
		log.error("知识库内容表 getTopicByCon 使用了es KbsTopicRepositoryImpl ");
