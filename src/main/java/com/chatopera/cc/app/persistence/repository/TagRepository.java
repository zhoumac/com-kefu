...
public abstract interface TagRepository  extends JpaRepository<Tag, String>
{
	...
	public abstract Tag findByTag(String tag);
	...
	@Query(value = "select t from Tag t where (:tagtype is null or t.tagtype = :tagtype) ")
	public Page<Tag> findByTagtype(@Param("tagtype") String tagtype, Pageable paramPageable);
	
	public abstract List<Tag> findByOrgi(String orgi);
	
	public abstract List<Tag> findByOrgiAndTagtype(String orgi , String tagtype);

	public abstract List<Tag> findByTagtype(String tagtype);
}
