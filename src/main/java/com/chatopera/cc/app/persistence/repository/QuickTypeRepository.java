...
public abstract interface QuickTypeRepository extends JpaRepository<QuickType, String> {
	...
	public abstract List<QuickType> findByQuicktype(String quicktype);
	...
	public abstract List<QuickType> findByQuicktypeAndCreater(String quicktype, String creater);

	public abstract int countByOrgiAndNameAndParentid(String orgi , String name , String parentid) ;

	public abstract int countByNameAndParentid(String name, String parentid);
