...
import com.chatopera.cc.util.TempletLoader;
...
public class MainUtils {
	...
	public static String md5(String str) {
		//////////----->为配合安全登录,此处改为生成真32位小写MD5算法    by Wayne on 2019/9/15 17:50   start--->
//        return md5.getMD5ofStr(md5.getMD5ofStr(str));
		return DigestUtils.md5Hex(str);
		//////////<-----为配合安全登录,此处改为生成真32位小写MD5算法   by Wayne on 2019/9/15 17:50    <---end
	}
...
//                if (MainUtils.md5(confirm).equals(secret.getPassword())) {
				...
				if (DigestUtils.md5Hex(confirm).equals(secret.getPassword())) {
					execute = true;
				}
			}
