...
public class UKWebAppConfigurer 
    ...
    public void addInterceptors(InterceptorRegistry registry) {
	    ...
	    registry.addInterceptor(new UserInterceptorHandler()).addPathPatterns("/**").excludePathPatterns(new String[]{
			    "/login.html", "/im/**", "/res/image*", "/res/file*", "/cs/**", "/getUserUuid", "/admin/pay/payMsg/payInfoView"});
