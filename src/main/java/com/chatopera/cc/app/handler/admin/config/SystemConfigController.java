...
//                    if (StringUtils.isNotBlank(oldpass) && MainUtils.md5(oldpass).equals(tempSecret.getPassword())) {
                    if (StringUtils.isNotBlank(oldpass) && DigestUtils.md5Hex(oldpass).equals(tempSecret.getPassword())) {
//                        tempSecret.setPassword(MainUtils.md5(secret.getPassword()));
                        tempSecret.setPassword(DigestUtils.md5Hex(secret.getPassword()));
                        msg = "1";
...
//                    secret.setPassword(MainUtils.md5(secret.getPassword()));
                    // 因修改登录方法,所以修改加密方法为真MD5算法
                    secret.setPassword(DigestUtils.md5Hex(secret.getPassword()));
