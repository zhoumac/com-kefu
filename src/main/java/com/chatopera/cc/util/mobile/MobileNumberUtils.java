...
//	@Value("${mobile.data.path}")
	private static String MOBILE_DATA_PATH = "d:/chunsung/mobile.data";
	
	public static int init() throws IOException{
		File file = new File( MobileNumberUtils.class.getResource(MOBILE_DATA_PATH).getFile());
