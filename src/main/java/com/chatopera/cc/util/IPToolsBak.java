...
//
//public class IPToolsBak {
//	private String IP_DATA_PATH = "WEB-INF/data/ip/ip2region.db";
//	private static IPToolsBak iptools = new IPToolsBak();
//	private DbSearcher _searcher = null ;
//	
//	public static IPToolsBak getInstance(){
//		return iptools ;
//	}
//
//	public IPToolsBak() {
...
//			if(!dbFile.exists()){
//				FileUtils.copyInputStreamToFile(IPToolsBak.class.getClassLoader().getResourceAsStream(IP_DATA_PATH),dbFile);
//			}
